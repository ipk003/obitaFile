            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <form class="form-inline" id="search_from" name="search_from">
                        <label class="control-label" for="inputBookName">数据文件名：</label>
                        <input class="form-control" type="text" id="inputBookName" name="inputBookName"/>
                        <label class="control-label" for="inputAuthor">数据地名：</label>
                        <input class="form-control" type="text" id="inputAuthor" name="inputAuthor"/>
                        <label class="control-label" for="inputQual">质量：</label>
                        <input class="form-control" type="text" id="inputQual" name="inputQual"/>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id = "confirmTable" name = "confirmTable" class="table table-bordered">
                    <tr>
                        <th style="text-align:center">数据文件名</th>
                        <th style="text-align:center">数据地名</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            columns: [
                ...
                <#-- 
                {
                    ...
                    formatter: function (value, row, index) {
                        var operateHtml = '<button type="button" class="btn btn-primary btn-sm addbtn" onclick="addReserve(\''+row.bookId+'\',\''+row.bookName+'\',\''+row.bookAuthor+'\',\''+row.bookPress+'\')"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 加入预定下载</button>';
                        return operateHtml;
                    }
                }]
        });
     ...
     function queryParams(params) {
         return {
             ...
             inputQual : $('#search_from input[name=\'inputQual\']').val(),// 请求时向服务端传递的参数
         }
     }
     /**
      * 查询图书
     ...
     function findBook() {
         ...
         $('#search_from input[name=\'inputQual\']').val('');
     }
    /*
     * 添加预定图书
     * */
    ...
    function reserveBook(){
        ...
        layer.confirm('确定预定这些数据吗?', {icon: 3, title:'提示'}, function(index){
            $.ajax({
                type: "POST",
                dataType: "json",
