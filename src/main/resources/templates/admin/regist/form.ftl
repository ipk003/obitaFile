                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/regist">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <!--onblur 离开输入时验证  -->
                                <input data-exist="userCode" id="userCode" name="userCode" class="form-control" placeholder="请输入您的工号。" type="text" value="${user.userCode}" <#if user?exists> readonly="readonly"</#if> >
                            </div>
                        </div>
                        <div class="form-group">
