...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        <strong class="font-bold">数据管理系统</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">数据管理系统
                    </div>
                </li>
                ...
                <li>
                    <a class="J_menuItem" href="${ctx!}/admin/welcome">
                        ...
                        <span class="nav-label">数据查询&下载</span>
                    </a>
                </li>
                 <li>
                 ...
                 <li>
                    <a class="J_menuItem" href="${ctx!}/admin/borrow">
                     <i class="fa fa-bookmark-o" aria-hidden="true"></i>
                        <span class="nav-label">我的下载</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="J_menuItem" href="${ctx!}/admin/role/index"><i class="fa fa-user-plus" aria-hidden="true"></i>权限管理</a>
                </li>
            </@shiro.hasPermission>
            <@shiro.hasPermission name="system:books:book_management">
            <li>
                <a class="J_menuItem" href="${ctx!}/web/books/index"><i class="fa fa-book" aria-hidden="true"></i>&nbsp;数据管理</a>
            </li>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="system:resource:index">
        <li>
            <a class="J_menuItem" href="${ctx!}/admin/resource/index"><i class="fa fa-check-square" aria-hidden="true"></i>&nbsp;权限设置</a>
        </li>
    </@shiro.hasPermission>
   ...
   <!--数据生产管理系统-->
    ...
    <li>
                    <a href="#">
                        <i class="fa fa fa-cog"></i>
                        <span class="nav-label">数据生产管理</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <@shiro.hasPermission name="system:user:index">
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/product/index"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;流程监控</a>
                        </li>
                    </@shiro.hasPermission>
                    <@shiro.hasPermission name="system:role:index">
                <li>
                    <a class="J_menuItem" href="${ctx!}/admin/role/index"><i class="fa fa-user-plus" aria-hidden="true"></i>资源监控</a>
                </li>
            </@shiro.hasPermission>
            <@shiro.hasPermission name="system:books:book_management">
            <li>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> <span class="label label-primary"></span>你好：&nbsp;<@shiro.principal type="cn.edu.jxnu.base.entity.User" property="userName"/>
                    </a>
