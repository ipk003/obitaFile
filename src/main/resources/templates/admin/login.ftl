...
<body class="signin">
	<div class="signinpanel">
		<div class="row">
			<div class="col-sm-12">
				...
				<form method="post" action="${ctx!}/admin/login" id="frm">
					<h3 class="no-margins">数据管理系统</h3>
					<h4 class="no-margins">登录：</h4>
					<input type="text" class="form-control uname" name="usercode"
						id="usercode" placeholder="工号" /> <input type="password"
		...
		<div class="signup-footer">
			<div class="pull-left">&copy;数据管理</div>
		</div>
	</div>
